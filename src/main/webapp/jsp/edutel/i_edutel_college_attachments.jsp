	...
	<div id="edutelAttachContent" class="edutelAttachContent">
		<s:if test="#attachReadOnly !='true'">
			<table id="tblRequest" width="100%" border="0" class="backColor">
				<tr>
					<td class="txtLabel" nowrap="nowrap" width="10%" height="20"
						colspan="3">&nbsp;</td>
				...
				<tr>
					...
					<td class="txtLabel" nowrap="nowrap" width="10%" height="22"><span
						id="fileSizeSpan" class="lblstyle">&nbsp;&nbsp;&nbsp;Form
							Type</span></td>
					<td nowrap="nowrap" width="25%" align="center"><select
						name="college.clFormType" id="clFormType"
						style="width: 100px; vertical-align: middle; padding: 0px;">
							<option value="EntranceForm">Entrance Form</option>
							<option value="CollegeForm">College Form</option>
					</select></td>
					<td class="txtLabel" nowrap="nowrap" width="10%" height="22"><span
					...
					<td width="35%" align="left" valign="bottom">&nbsp;&nbsp;&nbsp;<img
