...
<div id="edutelAttach" style="width: 100%;">
		...
		<table class="toggelCSS" style="width: 100%">
			<tr class="edutelAttachToggle" height="25" valign="bottom">
				<td width="97%" valign="middle"><span
					style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;${attachmentBannerName}</span></td>
				<td width="03%">&nbsp;</td>
			</tr>
		</table>
	</div>
	<div id="edutelAttachContent" class="edutelAttachContent">
		<table id="tblRequest" width="100%" border="0" class="backColor">
			<tr>
				<td class="txtLabel" nowrap="nowrap" width="100%" height="22"
					colspan="2" align="center"><span id="fileSizeSpan"
					class="lblstyle" style="text-align: middle;">Max 5MB Size </span></td>
			</tr>
			<tr>
				<td nowrap="nowrap" width="40%" align="center"><span
					id="fileSizeSpan" class="lblstyle">&nbsp;&nbsp;&nbsp;${attachmentName}&nbsp;&nbsp;</span><input
					type="text" name="uploadFileDisplayName"
					id="uploadFileDisplayName1"></td>
				<td width="60%" align="center">
					<div class="fileinputs" id="fileinputs1">
						<input type="file" name="uploadFiles" id="fileUpload1"
