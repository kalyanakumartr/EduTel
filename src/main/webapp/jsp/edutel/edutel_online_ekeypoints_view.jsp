...
<script>
	function loadEKeyPointsBySubject() {
		var url = "onlineEKeyPointsListByAjax.do?sEcho=EKeyPoints&sSearch="
	...
	function downloadEKeyPoints(oeKeyPointsId) {
		var url = "downloadEKeyPointsByAjax.do?oeKeyPointsId=" + oeKeyPointsId
				+ "&uid=" + Math.random();
	...
	<div id="wrap" class="boxed">
		...
		<div class="container whiteBg clearfix">
				...
				<div id="onlineEKeyPointsDiv">
					<table>
						<tr>
							...
							<td width="40%" style="padding:5px;"><s:select name="oeSubject" id="oeSubject" style="width:180px;" list="subjectList" listKey="label" listValue="value" theme="simple"
							...
							<td width="40%" style="padding:5px;"><select name="oeChapter" id="oeChapter" style="width: 100px; vertical-align: middle; padding: 0px;"
								onchange="loadEKeyPointsBySubject();">
			...
			<div id="dashBoardDiv" align="center" style="height: 400px;">
				<s:include value="/jsp/edutel/edutel_online_ekeypoints_view_docs.jsp" />
			</div>
		</div>
	</div>
	<footer>
