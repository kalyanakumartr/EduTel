...
<script>
	function onsubmitCalled() {
		...
		document.forms["schoolUpdationForm"].submit();
	}

	function onresetCalled() {
		document.forms["schoolUpdationForm"].reset();
	}
	...
	<div id="wrap" class="boxed">
		...
		<div class="container whiteBg clearfix">
			<div class="latest-title">
				<p>School Update Form</p>
			</div>
			<div id="signupwrapper" align="center">
				<s:form name="schoolUpdationForm" id="schoolUpdationForm"
					action="schoolUpdate.do" method="post"
							...
							<tr>
								<td>
									<div id="schoolRegistrationDiv"
										...
										<s:hidden name="school.scSchoolId" id="scSchoolId" />
										<table align="center" cellpadding="0" cellspacing="0"
											...
											<tr>
												<td align="center" colspan="4"><input type="button"
													class="btnstyle" style="width: 150px;" name="updateSchool"
													value="Update School" href="javascript:void(0);"
													onclick="onsubmitCalled();" /> &nbsp;&nbsp; <input
													type="button" class="btnstyle" value="Cancel"
													onclick="onCancelCalled('searchSchool.do')" />&nbsp;&nbsp;</td>
											</tr>
											<tr>
												<td align="left" class="usertext" colspan="4">&nbsp;&nbsp;&nbsp;</td>
											</tr>
