...
<script>
	function onsubmitCalled() {
		...
		document.forms["collegeRegistrationForm"].submit();
	}

	function onresetCalled() {
		document.forms["collegeRegistrationForm"].reset();
	}
</script>
</head>
	...
	<div id="wrap" class="boxed">
		...
		<div class="container whiteBg clearfix">
			<div class="latest-title">
				<p>College Registration Form</p>
			</div>
			<div id="signupwrapper" align="center">
				<s:form name="collegeRegistrationForm" id="collegeRegistrationForm"
					action="collegeRegistration.do" method="post"
										...
										<table align="center" cellpadding="0" cellspacing="0"
											...
											<tr>
												<td align="left" class="usertext" colspan="4"><s:include
														...
														<s:param name="attachmentBannerName">Application Form</s:param>
														<s:param name="attachmentName">Form</s:param>
											...
											<tr>
												<td align="center" colspan="4"><input type="button"
													class="btnstyle" name="saveCollege" value="Save College"
													href="javascript:void(0);" onclick="onsubmitCalled();" />
													&nbsp;&nbsp; <input type="button" class="btnstyle"
													value="Reset" onclick="onresetCalled()" />
													&nbsp;&nbsp;&nbsp;&nbsp;</td>
											</tr>
											<tr>
												<td align="left" class="usertext">&nbsp;&nbsp;&nbsp;</td>
