...
<script>
	...
	function addUploadRow() {
		try {
			...
			if (fileCnt == 0
				...
				var strHtml3 = "&nbsp;&nbsp;&nbsp;<img SRC='images/png/minus.png' BORDER='0'ALT='' style='cursor: pointer;' onclick='javascript:deleteRequestUpload(this)' title='Remove file'>";
	...
	function checkDocumentType(str, count) {
		...
		if ($.inArray(ext, [ 'tiff', 'tif', 'doc', 'docx', 'xls', 'xlsx',
				'txt', 'pdf', 'jpg', 'jpeg' ]) == -1) {
			...
			u.innerHTML = "<input type=\'file\' name=\'uploadFiles\' id=\'"
					...
					+ str.id + "," + count + ");'/>";
			alert('Invalid File Format!\n\nPlease select valid file format(jpg or jpeg).');
			return false;
		}
		return true;
	}
